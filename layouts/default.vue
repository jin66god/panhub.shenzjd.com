<template>
  ...
  <!-- fork 定制：links 属性覆盖默认导航，全部指向本站（保留 fork 原有导航定制，2026-08-30） -->
  <!-- ⚠️ site-navbar 用 getAttribute("links") 读 JSON 字符串，必须 JSON.stringify 后传字符串 -->
  <ClientOnly>
    <site-navbar :links="forkNavLinksJson"></site-navbar>
  </ClientOnly>
...
// fork 定制：导航链接（原 app.vue navLinks 定制，上游改为 site-navbar Web Component 后
// 通过 links 属性注入，保留 fork 全部指向 panhub.456996.xyz 的导航配置，2026-08-30）
const forkNavLinks = [
  { label: "首页", href: "https://panhub.456996.xyz" },
  { label: "Alist", href: "https://panhub.456996.xyz" },
  { label: "网盘搜索", href: "https://panhub.456996.xyz", active: true },
  { label: "视频解析", href: "https://panhub.456996.xyz" },
  { label: "热点聚合", href: "https://panhub.456996.xyz" },
  { label: "个人导航", href: "https://panhub.456996.xyz" },
  { label: "必应壁纸", href: "https://panhub.456996.xyz" },
];
const forkNavLinksJson = JSON.stringify(forkNavLinks);
